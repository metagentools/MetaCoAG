...
## Dependencies
MetaCoAG installation requires python 3.6 or above. You will need the following python dependencies to run MetaCoAG and related support scripts.
...
You will also need the following tools installed and added to your system path.
